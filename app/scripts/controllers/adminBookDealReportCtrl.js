(function () {
    ...
    AdminUserReportCtrl.$inject = ['$moment', '$timeout', '$state', 'identityService', 'adminDashboardService', '$scope', '$filter', '$q', 'ngTableParams', 'responseService', 'SERVER_CONSTANT'];

    function AdminUserReportCtrl($moment, $timeout, $state, identityService, adminDashboardService, $scope, $filter, $q, ngTableParams, responseService, SERVER_CONSTANT) {
